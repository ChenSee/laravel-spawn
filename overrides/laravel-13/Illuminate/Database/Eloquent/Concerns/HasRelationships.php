...
trait HasRelationships
{
    ...
    {
        return new CoroutineHasOneThrough($query, $farParent, $throughParent, $firstKey, $secondKey, $localKey, $secondLocalKey);
    }
    ...
    {
        return new CoroutineHasManyThrough($query, $farParent, $throughParent, $firstKey, $secondKey, $localKey, $secondLocalKey);
    }
    ...
    protected function newBelongsToMany(
        ...
        return new CoroutineBelongsToMany($query, $parent, $table, $foreignPivotKey, $relatedPivotKey, $parentKey, $relatedKey, $relationName);
    }
